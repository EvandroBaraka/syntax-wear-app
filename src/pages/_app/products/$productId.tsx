...
export const Route = createFileRoute("/_app/products/$productId")({
    ...
    head: ({ loaderData }) => {
        if (!loaderData) {
            return {
                meta: [
                    {
                        title: "Produto não encontrado - Produtos - Syntax Wear",
                        description: "Produto não encontrado na Syntax Wear.",
                    },
                ],
            };
        }
        ...
        return {
            meta: [
                {
                    title: `${loaderData?.product?.name} - Produtos - Syntax Wear`,
                    description: `Confira o produto ${loaderData?.product?.name} na Syntax Wear.`,
                },
            ],
        };
    },
    ...
    notFoundComponent: () => (
        <section className="container flex flex-col items-center min-h-[80vh] mb-10 pt-44 md:pt-54 pb-10 md:px-10 text-center text-black">
        ...
        <section className="container mb-10 pt-44 md:pt-54 pb-10 md:px-10">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-10">
                ...
                <div className="flex-1 w-full max-w-125 text-black">
                    ...
                    <p className="max-w-125 mb-5">{product?.description}</p>
