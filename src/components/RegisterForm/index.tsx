...
export const RegisterForm = () => {
    ...
    return (
        <form className="text-black">
            ...
            <button disabled={isSubmitting} type="submit" className="w-full bg-[#5433EB] text-white font-semibold uppercase py-3 rounded-md transition-all hover:bg-[#4028c7] disabled:opacity-50 cursor-pointer mt-4">
